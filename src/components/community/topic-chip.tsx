...
export function TopicChip({ topic, size = 'sm', className }: Props) {
  return (
    <Link
      ...
      className={cn(
        'inline-flex max-w-full items-center rounded-full border border-borderSoft bg-surface-2 text-textSecondary hover:text-textPrimary hover:border-textPrimary/30 hover:bg-surface transition-colors',
