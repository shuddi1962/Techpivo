      ...
      {platforms.map((platform) => (
        ...
        >
          ...
          {copied === platform.name && (
            <span className="absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] font-medium bg-black text-white dark:bg-white dark:text-black px-2 py-0.5 rounded">Link copied</span>
          )}
        </button>
      ))}
    </div>
