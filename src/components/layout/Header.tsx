...
export function Header() {
  ...
  const dynamicHeaderPages = getPagesForPlacement(["header", "menu", "both"]).filter((p) => !hardcodedSlugs.has(p.slug))
        ...
        <div className="header-inner">
          ...
          <div className="header-controls">
            ...
            {dynamicHeaderPages.map((p) => (
              <Link key={p.slug} href={p.path} className="header-nav-link"><span>{p.label}</span></Link>
            ))}
        ...
        <div className="header-mobile-drawer" onClick={() => setDrawerOpen(false)}>
          <div className="mobile-drawer-panel" onClick={e => e.stopPropagation()}>
            ...
            {pageVisible("advertise") && (
              ...
              {dynamicHeaderPages.map((p) => (
                <Link key={p.slug} href={p.path} className="mobile-drawer-link" onClick={() => setDrawerOpen(false)}>
