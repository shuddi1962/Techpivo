...
export function PostCard({ post }: PostCardProps) {
  return (
    <Link href={`/${post.slug}`} className="group block rounded-lg border border-[#333333] bg-[#1a1a1a] overflow-hidden hover:border-[#6366F1] hover:-translate-y-0.5 transition-all duration-200">
      ...
      <div className="p-4">
        <h3 className="text-lg font-semibold text-[#e5e5e5] line-clamp-2 group-hover:text-[#6366F1] transition-colors mb-2">{post.title}</h3>
