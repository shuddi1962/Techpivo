...
interface Platform {
  ...
  getUrl: (title: string, url: string, excerpt: string, image: string) => string | null
}
...
const platforms: Platform[] = [
  {
    ...
    getUrl: (_t: string, url: string, _e: string, _i: string) =>
  ...
  },
  {
    ...
    getUrl: (title: string, url: string, _e: string, image: string) =>
      image
