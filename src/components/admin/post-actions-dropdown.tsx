...
import { MoreHorizontal, Eye, Settings, Trash2, ExternalLink, Loader2, Share2 } from "lucide-react"
...
export function PostActionsDropdown({ postId, slug, title, excerpt, featured_image, tags }: PostActionsDropdownProps) {
  ...
  return (
    <>
      <div ref={ref} className="relative">
        ...
        {open && (
          <div className="absolute right-0 top-full mt-1 z-50 w-48 bg-white dark:bg-[#111827] border-2 border-gray-200 dark:border-[#374151] rounded-xl shadow-2xl overflow-hidden">
            <div className="py-1">
              <a
              ...
              <button
                ...
                className="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-[#D1D5DB] hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors"
              >
      ...
      <SocialShareDialog
        ...
        post={{ id: postId, slug, title: title || slug, excerpt, featured_image, tags }}
      />
    </>
  )
}
