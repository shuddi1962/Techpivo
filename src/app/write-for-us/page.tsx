  ...
  return (
    <div className="w-full">
      ...
      <div className="relative overflow-hidden mb-12 min-h-[320px] flex items-center">
        <Image src="https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg" alt="Write for us" width={1200} height={675} className="absolute inset-0 w-full h-full object-cover" />
