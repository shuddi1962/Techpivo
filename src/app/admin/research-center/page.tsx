...
export default function ResearchCenterPage() {
  ...
  const handleResearch = async () => {
    ...
    setBrief({
      ...
      topic,
      summary: `Research brief for "${topic}" — This topic covers recent developments and provides opportunities for TechPivo coverage with strong search potential.`,
      sources: [
        { title: "Official Documentation", url: "https://example.com/docs", tier: 1 },
        { title: "Tech News Coverage", url: "https://example.com/news", tier: 2 },
        { title: "Community Discussion", url: "https://example.com/community", tier: 3 },
      ],
      suggested_angle: `A comprehensive guide to ${topic}, covering what's new, why it matters, and how it impacts developers and tech professionals.`,
      suggested_category: "tech-news",
      suggested_tags: [topic.split(" ")[0], "Technology", "2026"],
      keyword_cluster: [topic.toLowerCase(), `${topic.toLowerCase()} guide`, `best ${topic.toLowerCase()}`],
      status: "pending",
    })
